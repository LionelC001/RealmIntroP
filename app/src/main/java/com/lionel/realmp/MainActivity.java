...
import com.lionel.realmp.model.Cat;
import com.lionel.realmp.model.Dog;
import com.lionel.realmp.model.Person;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new MainActivity.ComplexBackgroundOperations(this).execute();
    }
    ...
    private static class ComplexBackgroundOperations extends AsyncTask<Void, Void, String> {
        ...
        public ComplexBackgroundOperations(MainActivity mainActivity) {
